...
/*  BEWARE OF THE COPY-PASTE!
    ...
    The code below also needs no further comments or documentation. It should
    also reside at the very end of this code file. */

CPAKT_EXTERN_C
void
cpakt_impl_assert_int_eq(cpakt_longest_int a, char const* a_expr,
                         cpakt_longest_int b, char const* b_expr,
             char const* file, int line) {
    int success = (a == b);
    if (!success)
...
CPAKT_EXTERN_C
void
cpakt_impl_assert_int_ne(cpakt_longest_int a, char const* a_expr,
             cpakt_longest_int b, char const* b_expr,
             char const* file, int line) {
    int success = (a != b);
    if (!success)
...
CPAKT_EXTERN_C
void
cpakt_impl_assert_int_lt(cpakt_longest_int a, char const* a_expr,
             cpakt_longest_int b, char const* b_expr,
             char const* file, int line) {
    int success = (a < b);
    if (!success)
...
CPAKT_EXTERN_C
void
cpakt_impl_assert_int_le(cpakt_longest_int a, char const* a_expr,
             cpakt_longest_int b, char const* b_expr,
             char const* file, int line) {
    int success = (a <= b);
    if (!success)
